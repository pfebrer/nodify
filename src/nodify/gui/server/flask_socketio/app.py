...
from nodify._env import register_env_variable, get_env_variable
...
register_env_variable("NODIFY_SERVER_HOST", "localhost",
                          "The host where the GUI will run when self-hosted by the user.",
                          process=str)
register_env_variable("NODIFY_SERVER_PORT", 4000,
